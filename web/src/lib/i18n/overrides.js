...
export const hi = {
  ...
  register: {
    title: "निवेशक खाता बनाएँ", subtitle: "AKSHYA INVESTMENTS में शामिल हों — केवल INR, 42 संरचित योजनाएँ",
  ...
  auth: {
    ...
    welcomeInvest: "AKSHYA INVESTMENTS में वापस स्वागत है",
  },
};
...
export const bn = {
  ...
  register: { title: "বিনিয়োগকারী অ্যাকাউন্ট তৈরি", subtitle: "AKSHYA INVESTMENTS — INR, ৪২ পরিকল্পনা", createAccount: "অ্যাকাউন্ট তৈরি", creating: "তৈরি হচ্ছে…", back: "পিছনে", alreadyHave: "ইতিমধ্যে অ্যাকাউন্ট আছে?" },
...
export const te = {
  ...
  register: { title: "పెట్టుబడిదారు ఖాతా", subtitle: "AKSHYA INVESTMENTS — INR, 42 ప్లాన్లు", createAccount: "ఖాతా సృష్టించు", creating: "సృష్టిస్తోంది…", back: "వెనక్కి", alreadyHave: "ఇప్పటికే ఖాతా ఉందా?" },
...
export const ta = {
  ...
  register: { title: "முதலீட்டாளர் கணக்கு", subtitle: "AKSHYA INVESTMENTS — INR, 42 திட்டங்கள்", createAccount: "கணக்கு உருவாக்கு", creating: "உருவாக்குகிறது…", back: "பின்", alreadyHave: "ஏற்கனவே கணக்கு உள்ளதா?" },
...
export const mr = {
  ...
  register: { title: "गुंतवणूकदार खाते", subtitle: "AKSHYA INVESTMENTS — INR, 42 योजना", createAccount: "खाते तयार करा", creating: "तयार होत आहे…", back: "मागे", alreadyHave: "आधीच खाते आहे?" },
...
export const gu = {
  ...
  register: { title: "રોકાણકાર એકાઉન્ટ", subtitle: "AKSHYA INVESTMENTS — INR, 42 યોજનાઓ", createAccount: "એકાઉન્ટ બનાવો", creating: "બનાવી રહ્યા છીએ…", back: "પાછળ", alreadyHave: "પહેલેથી એકાઉન્ટ છે?" },
...
export const kn = {
  ...
  register: { title: "ಹೂಡಿಕೆದಾರ ಖಾತೆ", subtitle: "AKSHYA INVESTMENTS — INR, 42 ಯೋಜನೆಗಳು", createAccount: "ಖಾತೆ ರಚಿಸಿ", creating: "ರಚಿಸಲಾಗುತ್ತಿದೆ…", back: "ಹಿಂದೆ", alreadyHave: "ಈಗಾಗಲೇ ಖಾತೆ ಇದೆಯೇ?" },
...
export const ml = {
  ...
  register: { title: "നിക്ഷേപക അക്കൗണ്ട്", subtitle: "AKSHYA INVESTMENTS — INR, 42 പദ്ധതികൾ", createAccount: "അക്കൗണ്ട് സൃഷ്ടിക്കുക", creating: "സൃഷ്ടിക്കുന്നു…", back: "പിന്നോട്ട്", alreadyHave: "ഇതിനകം അക്കൗണ്ട് ഉണ്ടോ?" },
...
export const pa = {
  ...
  register: { title: "ਨਿਵੇਸ਼ਕ ਖਾਤਾ", subtitle: "AKSHYA INVESTMENTS — INR, 42 ਯੋਜਨਾਵਾਂ", createAccount: "ਖਾਤਾ ਬਣਾਓ", creating: "ਬਣ ਰਿਹਾ ਹੈ…", back: "ਪਿੱਛੇ", alreadyHave: "ਪਹਿਲਾਂ ਤੋਂ ਖਾਤਾ ਹੈ?" },
...
export const or = {
  ...
  register: { title: "ବିନିଯୋଗକାରୀ ଖାତା", subtitle: "AKSHYA INVESTMENTS — INR, 42 ଯୋଜନା", createAccount: "ଖାତା ତିଆରି", creating: "ତିଆରି ହେଉଛି…", back: "ପଛକୁ", alreadyHave: "ପୂର୍ବରୁ ଖାତା?" },
...
export const as = {
  ...
  register: { title: "বিনিয়োগকাৰী একাউণ্ট", subtitle: "AKSHYA INVESTMENTS — INR, 42 পৰিকল্পনা", createAccount: "একাউণ্ট সৃষ্টি", creating: "সৃষ্টি হৈ আছে…", back: "পিছলৈ", alreadyHave: "আগতে একাউণ্ট আছে?" },
...
export const ur = {
  ...
  register: { title: "سرمایہ کار اکاؤنٹ", subtitle: "AKSHYA INVESTMENTS — INR، 42 منصوبے", createAccount: "اکاؤنٹ بنائیں", creating: "بن رہا ہے…", back: "واپس", alreadyHave: "پہلے سے اکاؤنٹ؟" },
