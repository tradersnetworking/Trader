...
export function InvestRiskDisclosure() {
  return (
    <LegalPage title="Risk Disclosure">
      <p>Investments in Akshaya Exim Traders plans carry market, liquidity, and operational risks. Past performance does not guarantee future returns.</p>
...
export function InvestTermsOfService() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <p className="mt-3">Akshaya Exim Traders may suspend accounts for fraud, AML concerns, or violation of platform policies.</p>
    </LegalPage>
  );
}
