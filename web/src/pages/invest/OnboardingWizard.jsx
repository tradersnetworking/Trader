...
export default function OnboardingWizard() {
  ...
  return (
    <div className="mx-auto min-w-0 max-w-2xl px-4 py-6 sm:py-8">
      ...
      <p className="page-subtitle mt-1">Complete these steps to start investing with AKSHYA INVESTMENTS. All amounts are in INR (₹).</p>
      ...
      <div className="card mt-6 space-y-4 p-4 sm:p-6">
        {step === 1 && (
          <>
            <Alert type="info">Welcome to AKSHYA INVESTMENTS — structured plans with monthly ROI paid in Indian Rupees.</Alert>
